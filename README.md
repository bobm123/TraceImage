...
- Phases 6–7: not started. Note: Bézier smoothing (was Phase 6) is deprioritized in favor of the Inkscape export flavor above, which lets users adjust control points in Inkscape directly.
